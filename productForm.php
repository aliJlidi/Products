...
<body>
  <section id="Header">
    ...
    <div class="ButtonContainer">
      <button type="submit" form="myform" value="Save" name="save" class="btn btn-primary" style="margin-right: 10px;">Save</button>
  ...
  <section id="productForm" class="col-md-3 contents">
    ...
    <form id="myform" name="myform" class="form" action="productForm.php" method="POST">
      ...
      <div class="formElement">
        ...
        <input type="text" id="sku" name="sku" value="<?= $obj->sku ?>" class="form-control" style="width: 100%;" placeholder=" SKU">
      ...
      <div class="formElement">
        ...
        <input type="text" id="name" name="name" value="<?= $obj->name ?>" class="form-control " style="width: 100%;" placeholder="Name">
      ...
      <div class=" formElement">
        ...
        <input type="text" id="price" name="price" value="<?= $obj->price ?>" class="form-control " style="width: 100%;" placeholder="Price">
      ...
      <div class='size  formElement'>
        ...
        <input type="text" class="form-control " style="width: 100%;" id="size" name="size" value="<?= $obj->size ?>" placeholder="Size">
      ...
      <div class='height  formElement'>
        <div>
          ...
          <input type="text" class="form-control " style="width: 100%;" id="height" value="<?= $obj->height ?>" name="height" placeholder="Height">
          <span class="error">* <?php echo $obj->heightErr; ?> </span>
        </div>
        <div>
          <label class="label">Width(CM)</label>
          <input type="text" class="form-control " style="width: 100%;" id="width" value="<?= $obj->width ?>" name="width" placeholder="Width">

        </div>
        <div>
          <label class="label">Lenght(CM)</label>
          <input type="text" class="form-control " style="width: 100%;" id="length" value="<?= $obj->length ?>" name="length" placeholder="Lenght">
      ...
      <div class='weight formElement'>
        ...
        <input type="text" class="form-control " style="width: 100%;" id="weight" name="weight" value="<?= $obj->weight ?>" placeholder="Weight">
